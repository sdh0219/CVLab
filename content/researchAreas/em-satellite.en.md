...
keywords:
  ...
  - lightning whistlers
  - deep learning
  - electromagnetic anomaly extraction
order: 1
---

Electromagnetic satellites produce massive in-situ plasma wave observations, among which lightning whistlers are key signals for space-weather and seismo-electromagnetic studies. Manual inspection and threshold-based detection can hardly handle whistlers that are wide-band, low-SNR, and morphologically diverse.
